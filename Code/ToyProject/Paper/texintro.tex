...
There are \input{../DataClean/output/DemoNum.tex}observations in the data

Figure~\ref{fig:CutHist} shows the histogram of cut
\begin{figure}[H]
\centering
\includegraphics[width=6in]{../DataClean/output/figure/DemoFigure.pdf}
\caption{Cut Histogram}
\label{fig:CutHist}
\end{figure}
